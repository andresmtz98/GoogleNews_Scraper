...
def search_news(list_news, query):
    ...
    while(check):
        ...
        https://www.google.com/search?q=%s&tbs=qdr:d,sbd:1&tbm=nws&source=lnt&sa=X&ved=0ahUKEwiejO2quaPXAhWFJMAKHfbnDCMQpwUIHQ&biw=1400&bih=800&dpr=1&start=%s % (query, index)
